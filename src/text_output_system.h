...
class TextOutputSystem : public OutputSystem
{
 ...
 private:
  ...
  const std::unordered_multimap<int,std::string> m_defaultstrings{
    ...
    {EngineMessage::cmakeroom,"You created the room: <arg0>"},
    {EngineMessage::cmakeroom,"You can't create the room: <arg0>"},
    {EngineMessage::cmake,"You created the item: <arg0>"},
    {EngineMessage::cmake,"You can't create that item!"},
    {EngineMessage::cdelete,"You deleted the item: <arg0>"},
    {EngineMessage::cdelete,"You can't delete that item!"},
    {EngineMessage::cdestroy,"You destroyed the room to the <arg0>"},
    {EngineMessage::cdestroy,"You can't destroy that room!"},
    {EngineMessage::cjump,"You jumped to <arg0>"},
    {EngineMessage::cjump,"You can't jump to that room!"},
